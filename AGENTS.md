...
- Apple : utilisateur demande comment créer ses identifiants ; guide docs/configurer-apple.md préparé. App/Services IDs proposés seulement, non enregistrés ni fixés dans Expo. Attendre les valeurs effectivement créées et le chemin .p8 avant activation.
