...
- Recette du 18 septembre exécutée : lire docs/recette-2026-09-18.md. Domaine, écrans DOM et Supabase passent les scénarios listés ; consentements OAuth, agenda réel, rendu visuel et appareils restent non validés. Déroulé visible dans apps/mobile/public/recette.html + recette.js, stockage fictif isolé par ?recette=<id>. Ne pas le présenter comme une capture de tests serveur ni comme une émulation native. Tous les comptes/données QA de cette recette ont été nettoyés.
